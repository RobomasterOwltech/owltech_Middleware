...
/**
 * Computes the rotation matrix from the local coordinate 𝜗𝑅{𝐺𝑥𝑅𝑦𝑅} (mounted on the robot) to respect the globalcoordinate 𝜗f
 *
...
//The relationship between the wheels angular velocities and the robot linear and angular velocities is determined by:
// 𝜔 = JQ𝑇(𝜙)𝑞̇ 
